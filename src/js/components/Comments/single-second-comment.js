...
class SingleComment extends HTMLElement{
    ...
    connectedCallback(){
        this.innerHTML = singleSecondComment;
    }
}

window.customElements.define('single-secondcomment', SingleComment);